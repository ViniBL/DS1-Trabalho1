...
<html>
    ...
    <body>
	    ...
	    %>
        <a href="/Login/usuario/">Voltar</a>
	    <div align="center">
		    <h1>Pacotes de Viagens Adquiridos</h1>
		    ...
		    <table border="1">
                ...
                <c:forEach var="pacote" items="${requestScope.listaPacotes}">
                    <tr>
                        ...
                        <td><a href="/<%= contextPath%>/usuario/pacotes/proposta?id_pacote_adquirido=${pacote_adquirido.id_pacote_adquirido}">Cancelar</a>
