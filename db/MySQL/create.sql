...
insert into Usuario(nome, login, senha, papel, cpf, telefone, sexo, data_nascimento) values ('Usuario', 'user', 'user', 'USER', '11122233344', '16 999999999', 'F', '18-04-1994');

insert into Usuario(nome, login, senha, papel, cnpj, descricao) values ('Agencia1', 'agencia1', 'agencia1', 'AGENCIA', '123456789012345678', 'Agencia de Turismo 1');
insert into Usuario(nome, login, senha, papel, cnpj, descricao) values ('Agencia2', 'agencia2', 'agencia2', 'AGENCIA', '123456789012345679', 'Agencia de Turismo 2');
...
create table Pacote(id_pacote bigint not null auto_increment, id_usuario bigint not null, id_destino bigint not null, data_partida varchar(10) not null, duracao int not null, valor float not null, descricao varchar(256) not null, primary key(id_pacote), foreign key (id_usuario) references Usuario(id_usuario), foreign key (id_destino) references Destino(id_destino));


create table Pacotes_adquiridos(id_pacote_adquirido bigint not null auto_increment, id_usuario bigint not null, id_pacote bigInt not null, status varchar(9), primary key(id_pacote_adquirido), CONSTRAINT status_check CHECK (status IN('CANCELADO', 'ADQUIRIDO')));
...
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (3, 1, '10-08-2022', 7, 415.56, 'Executivo' );
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (3, 2, '05-08-2022', 7, 415.56, 'Convencional' );
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (4, 1, '10-08-2022', 7, 415.56, 'Semi Leito' );
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (4, 2, '05-08-2022', 7, 415.56, 'Executivo' );
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (3, 1, '10-08-2022', 7, 415.56, 'Convencional' );
insert into Pacote(id_usuario, id_destino, data_partida, duracao, valor, descricao) values (4, 2, '05-08-2022', 7, 415.56, 'Semi Leito' );


insert into Pacotes_adquiridos(id_usuario, id_pacote, status) values (2, 1, 'ADQUIRIDO');

insert into Pacotes_adquiridos(id_usuario, id_pacote, status) values (2, 2, 'ADQUIRIDO');
...
UPDATE Usuario SET nome ='cliente1', login ='user', senha ='user', papel ='USER', cpf ='11122233344', telefone ='16 999999999', sexo ='M', data_nascimento ='16-04-1994' WHERE id_usuario =2;
*/